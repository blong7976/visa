	...
	<view class="content">
		...
		<view class="form">
			<view class="form-group">
				<input type="text" v-model="phoneData.mobile" placeholder="请输入手机号码" />
				<image src="../../static/image/icon_del_s.png" v-if="phoneData.mobile" mode="aspectFit" class="close" @click="phoneData.mobile = ''"></image>
			</view>
			<view class="form-group">
				<input type="text" v-model="phoneData.code" placeholder="请输入密码"/>
			</view>
			...
			<view class="m-unlogin">
				...
				<text @click="navTo('/pages/login/Retrievepassword')">忘记密码</text>
			</view>
		</view>
		<view class="footer">
			<view class="title">
